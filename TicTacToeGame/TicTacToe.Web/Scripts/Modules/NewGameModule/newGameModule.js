 ...
 */
var newGameModule = (function (jQuery, ajaxCallsModule) {
    ...
    */
    chooseSidesDropdownChangeHandler = function (loadOponentsDropdownRequest) {
        $sidesDropdown.on('change', function () {
            var data = _stringifyData($(this).val());

            loadOponentsDropdownRequest(_antiForgeryToken, data).done(function (result) {
    ...
    */
    ...
    initializeModule = function (loadOponentsDropdownRequest) {
        chooseSidesDropdownChangeHandler(loadOponentsDropdownRequest);
    };
