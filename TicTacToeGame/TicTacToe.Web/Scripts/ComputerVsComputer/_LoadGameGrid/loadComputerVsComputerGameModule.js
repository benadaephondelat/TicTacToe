/**
 * Contains the JavaScript code to be used ComputerVsComputer Controller's _LoadGameGrid partial view
 ...
 */
var loadComputerVsComputerGameModule = (function (jQuery, ajaxCallsModule, loadGameGridModule) {
    ...
    /**
    * Calls computerVsComputerCalls.loadGameAjaxCall and appends the result to the DOM
    */
    loadGameRequest = function (data) {
        ajaxCallsModule.computerVsComputerCalls.loadGame(_antiForgeryToken, data).done(function (result) {
...
loadComputerVsComputerGameModule.init();