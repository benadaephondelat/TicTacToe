/**
 * Contains the JavaScript code to be used HumanVsComputer Controller's _LoadGameGrid partial view
 ...
 */
var loadHumanVsComputerGameModule = (function (jQuery, ajaxCallsModule, loadGameGridModule) {
    ...
    /**
    * Calls humanVsComputerCalls.loadGameAjaxCall and appends the result to the DOM
    */
    loadGameRequest = function (data) {
        ajaxCallsModule.humanVsComputerCalls.loadGame(_antiForgeryToken, data).done(function (result) {
...
loadHumanVsComputerGameModule.init();